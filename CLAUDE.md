...
script. Never hand-edit it. Adding a guide means updating the build script, `site/llms.txt`, and
`README.md`; the gate suite fails if any of those is missed. `.aiqt/gensrc.json` records this
relationship.
