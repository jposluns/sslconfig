...
- Helicone, self-hosted deployment (default `test@helicone.ai` / `password` login): https://docs.helicone.ai/getting-started/self-deploy and https://docs.helicone.ai/getting-started/self-host/manual
